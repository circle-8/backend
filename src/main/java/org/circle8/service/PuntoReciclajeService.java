...
public class PuntoReciclajeService {
	 ...
	 * @throws ServiceError
	 */
	public List<PuntoReciclajeDto> getPuntos() throws ServiceError{
		try {
			return this.dao.getPuntos();
		} catch (PersistenceException e) {
			throw new ServiceError("Ha ocurrido un error al obtener el listado de puntos", e);
		}
	}
}
