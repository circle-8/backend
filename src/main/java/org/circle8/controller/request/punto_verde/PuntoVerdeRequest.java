package org.circle8.controller.request.punto_verde;
...
public class PuntoVerdeRequest implements IRequest {
	...
	public PuntoVerdeRequest(Map<String, List<String>> queryParams) {
		try {
